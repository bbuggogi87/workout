window.PREP_CONSTANTS = {
    ...
    INITIAL_USER_INFO: { targetBF: '4.0', height: 173, weight: 72.5, targetDate: '2026-07-18' },
    INITIAL_CUSTOM_SUPPS: [ { id: 1, name: '단백질 보충제', weight: 30, kcal: 120, carbs: 3, protein: 24, fat: 1.5 } ],
    INITIAL_PHASES: [
        { 
