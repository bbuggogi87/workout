export const FOOD_DB = {
    // 탄수화물 (Carbohydrate)
    '백미':{c:0.317,p:0.026,f:0.003,k:1.46}, 
    '현미밥':{c:0.32,p:0.03,f:0.01,k:1.5}, 
    '감자':{c:0.20,p:0.02,f:0.001,k:0.86}, 
    '고구마':{c:0.27,p:0.02,f:0.001,k:1.16}, 
    ...
    '가래떡':{c:0.50,p:0.04,f:0.003,k:2.1},
    '꿀':{c:0.82,p:0.0,f:0.0,k:3.04},
    ...
    '소고기홍두깨살':{c:0.0,p:0.22,f:0.03,k:1.32},
    '연어':{c:0.0,p:0.20,f:0.13,k:2.0}, 
    '틸라피아':{c:0.0,p:0.20,f:0.017,k:0.98}, 
    '대구살':{c:0.0,p:0.17,f:0.006,k:0.78},
    '새우':{c:0.0,p:0.19,f:0.01,k:0.90},
...
export const FOOD_CATEGORIES = {
    '탄수화물':['백미','현미밥','고구마','감자','찐단호박','오트밀','바나나','사과','파스타(건면)','베이글','식빵','가래떡','꿀'],
    '단백질':['닭가슴살','닭다리살(껍질X)','돼지안심','소고기부채살','소고기우둔살','소고기홍두깨살','연어','틸라피아','대구살','새우','오징어','전란','난백액'],
